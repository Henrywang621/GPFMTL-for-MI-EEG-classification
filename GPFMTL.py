...
class gatemodule(Layer):
    ...
    def __init__(self, features_shape, **kwargs):
...
def GPFMTL(trial_length = 960, nchans = 68, nclasses = 2):
    ...
    out2  = Dense(nclasses, activation="sigmoid", name = 'output2')(out_flatten)   
